...
if (isset($_GET['id'])) {
    $deceasedId = $_GET['id'];
    $select = "SELECT * FROM intermentform WHERE id = $deceasedId";
    ...
    while ($edit = mysqli_fetch_assoc($query)) {
        ...
        $purok = $edit['purok'];
        $deceased = $edit['deceased'];
        $age = $edit['age'];
        $deathdate = $edit['deathdate'];
        $desired_date = $edit['desired_date'];
        $desired_time = $edit['desired_time'];
    }
}
?>
                                        ...
                                        <div class="col-sm">
                                            <div class="container-interment">
                                                <div class="formbold-main">
                                                    <div class="">
                                                        <form action="../dbConn/updateinterment.php" method="POST">
                                                            <input type="hidden" name="uid" value="<?php echo $deceasedId ?>">

                                                            <div class="formbold-mb-5">
                                                                <label for="name" class="formbold-form-label">Relationship to the
                                                                    Deceased
                                                                </label>
                                                                <input type="text" name="relationship" id="name" value="<?php echo $relationship ?>" placeholder="e.g Daughter" required="required" class="formbold-form-input" />
                                                            </div>
                                                                        ...
                                                                        <div class="formbold-mb-5 ">
                                                                            <div class="select">
                                                                                <select name="barangay" id="barangay" required>
                                                                                    <option value="<?php echo $barangay ?>" selected disable hidden>
                                                                                        <?php echo $barangay ?>
                                                                                    </option>
                                                                        ...
                                                                        <div class="formbold-mb-5  formbold-px-3">
                                                                            <div class="select">
                                                                                <select name="purok" id="purok" required>
                                                                                    <option value="<?php echo $purok ?>" disable selected hidden>
                                                                                        <?php echo $purok ?>
                                                                                    </option>
                                                            ...
                                                            <div class="formbold-mb-5">
                                                                ...
                                                                <input type="text" name="deceased" id="name" placeholder="Enter Full Name" required value="<?php echo $deceased ?>" class="formbold-form-input" />
                                                            </div>
                                                            <div class="formbold-mb-5">
                                                                <label for="name" class="formbold-form-label"> Age
                                                                </label>
                                                                <input type="text" name="age" id="name" placeholder="Enter Age" required value="<?php echo $age ?>" class="formbold-form-input" />
                                                            </div>
                                                            <div class="formbold-mb-5">
                                                                <label for="date" class="formbold-form-label">
                                                                    Date of Death </label>
                                                                <input type="date" name="deathdate" id="ddate" required value="<?php echo $deathdate ?>" class="formbold-form-input" />
                                                            </div>
                                                            <hr>
                                                            ...
                                                            <div class="formbold-mb-5 flex  ">
                                                                <div class="formbold-mb-5 w-full  ">
                                                                    <label for="date" class="formbold-form-label">
                                                                        Date </label>
                                                                    <input type="date" name="ddate" id="ddate" required value="<?php echo $desired_date ?>" class="formbold-form-input" />
                                                                </div>
                                                                <div class="formbold-mb-5 w-full  formbold-px-3">
                                                                    <label for="time" class="formbold-form-label">
                                                                        Time </label>
                                                                    <input type="time" name="time" id="time" value="<?php echo $desired_time ?>" class="formbold-form-input" />
                                                                </div>
                                                            </div>
