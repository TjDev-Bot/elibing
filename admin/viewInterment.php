...
if(isset($_GET['AppID']) && isset($_GET['ProfID'])){
    $appID = $_GET['AppID'];
    $profID = $_GET['ProfID'];
    ...
    while ($dataloc = $queryreserve->fetch_assoc()) {
        ...
        $level =$dataloc['Level'];
        $nl = $dataloc['NLName'];
        $sched = $dataloc['IntermentDateTime'];
...
<body>
                                            ...
                                            <div class="container-interment">
                                                <div class="formbold-main">
                                                    <div class="">
                                                        ...
                                                        <?php 
                                                        $select1 = "SELECT * FROM tblPayment WHERE profileID = '$profID'";
                                                        ...
                                                        <div class="formbold-mb-5 w-full  formbold-px-3">
                                                            <label for="name" class="formbold-form-label">Paid
                                                            </label>
                                                            <input type="text" name="CauseofDeath" id="name"
                                                                value="<?php echo $payment ?>" required
                                                                class="formbold-form-input" readonly />
                                                        </div>
                                                        <div class="formbold-mb-5 w-full  formbold-px-3">
                                                            <label for="name" class="formbold-form-label">Gatepass No
                                                            </label>
                                                            <input type="text" name="IntermentPlace" id="name"
                                                        ...
                                                        <div class="formbold-mb-5 w-full  formbold-px-3">
                                                            <label for="name" class="formbold-form-label">
                                                                Interment Schedule
                                                                (<?php echo date('F j, Y', strtotime($sched)); ?>)<span
                                                                    style="color:red; font-size: 8px;">*Optional to
                                                                    change the Interment Schedule</span>
                                                            </label>
                                                            <input type="date" name="sched" id="sched"
                                                                value="<?php echo date('F j, Y', strtotime($sched)); ?>"
    ...
    function redirectToNewPage() {
        var selectedProfID1 = document.getElementById('profID').value;
        Swal.fire({
            title: 'Confirmation',
            text: 'Are you sure you want to change the Interment Schedule?',
            icon: 'question',
            ...
            if (result.isConfirmed) {
                window.location.href = 'scheds1.php?profid=' + selectedProfID1;
            }
        });
    }
