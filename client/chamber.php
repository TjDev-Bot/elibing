...
<body>
                                ...
                                <div class="activity-log-container-scroll">
                                    <table class="table-no-border">
                                        ...
                                        <tbody>
                                            ...
                                            INNER JOIN tblIntermentReservation ON tblNiche.Nid = tblIntermentReservation.Nid
                                            INNER JOIN tblDeathRecord ON tblIntermentReservation.ProfID = tblDeathRecord.ProfileID 
                                            INNER JOIN tblNicheLocation ON tblNiche.LocID = tblNicheLocation.LocID WHERE tblNiche.LocID = '$block_id' ORDER BY ProfID DESC";
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-6 py-4">
                                                    ...
                                                    <button class="btn btn-primary "
                                                        onclick="viewOcuppant('<?php echo $block_id ?>', '<?php echo $profileid ?>')">
    ...
    function viewOcuppant(block_id, profid) {
        var url = 'viewoccchamber.php?locid=' + block_id + '&profid=' + profid;
        window.location.href = url;
    }
    </script>
    <style>
