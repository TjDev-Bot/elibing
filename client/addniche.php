                                    ...
                                    <table class="table-no-border">
                                        ...
                                        <tbody>
                                            ...
                                            while ($dataloc = $queryloc->fetch(PDO::FETCH_ASSOC)) {
                                                ...
                                                $countStatus1Query = "SELECT COUNT(*) AS status1Records FROM tblBuriedRecord WHERE Nid = '$nicheid' AND Status = 1";
                                                ...
                                                if ($totalRecords > 0 && $totalRecords === $status1Records) {
                                                    $updateStatusQuery = "UPDATE tblNiche SET Status = 0 WHERE Nid = '$nicheid'";
