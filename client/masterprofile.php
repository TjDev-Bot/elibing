                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                   <?php 
                                                       if ($type === 'Chamber') {
                                                        echo "<a href='chamber.php?locid=$id' class='btn btn-primary'><i class='bx bx-edit-alt'></i></a>";
                                                    } elseif ($type === 'Apartment') {
                                                        echo "<a href='addniche.php?locid=$id' class='btn btn-primary'><i class='bx bx-edit-alt'></i></a>";
                                                    }
                                                   ?>
                                                </td>
                                            </tr>
