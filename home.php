...
<body>
    ...
    <header class="header-home">
        ...
        <div class="overlay">
            <h1 style="font-size:5vw; color:white; font-family:'Poppins';">e-Libing</h1>
            <p style="font-size:2vw; color:white;"> We cater electronic burial services including appointments, bookings, cadaver
